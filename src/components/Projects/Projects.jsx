function Projects() {
  return (
    <>
     <section id="projects" className="safe-x py-16 sm:px-8 sm:py-28">
        <div className="mx-auto max-w-6xl">
          <div className="mb-10 text-center sm:mb-14" data-aos="fade-up" data-aos-duration="650">
            <span className="text-xs font-semibold uppercase tracking-widest text-violet-400 sm:text-sm">Projects</span>
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-8 lg:grid-cols-3">
            <article className="flex flex-col overflow-hidden rounded-2xl border border-[#2a2a3a] bg-[#12121a] card-hover" data-aos="fade-up" data-aos-duration="650" data-aos-delay="0">
              ...
              <div className="flex flex-1 flex-col p-6">
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  <span className="text-xs text-violet-400">HTML</span>
                  <span className="text-xs text-violet-400">Tailwind</span>
                  <span className="text-xs text-violet-400">JS</span>
                </div>
                <a href="https://github.com/kashvi147/My-portfolio" target="_blank" rel="noopener noreferrer" className="mt-5 text-sm font-semibold text-violet-400 hover:text-violet-300">View on GitHub →</a>
              </div>
            </article>
            ...
            <article className="flex flex-col overflow-hidden rounded-2xl border border-[#2a2a3a] bg-[#12121a] card-hover" data-aos="fade-up" data-aos-duration="650" data-aos-delay="100">
              ...
              <div className="flex flex-1 flex-col p-6">
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  <span className="text-xs text-violet-400">JavaScript</span>
                  <span className="text-xs text-violet-400">CSS</span>
                  <span className="text-xs text-violet-400">HTML</span>
                </div>
                <a href="https://github.com/kashvi147/campusverse" target="_blank" rel="noopener noreferrer" className="mt-5 text-sm font-semibold text-violet-400 hover:text-violet-300">View on GitHub →</a>
              </div>
            </article>
            ...
            <article className="flex flex-col overflow-hidden rounded-2xl border border-[#2a2a3a] bg-[#12121a] card-hover" data-aos="fade-up" data-aos-duration="650" data-aos-delay="100">
              ...
              <div className="flex flex-1 flex-col p-6">
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  <span className="text-xs text-violet-400">Arduino</span>
                  <span className="text-xs text-violet-400">C/C++</span>
                  <span className="text-xs text-violet-400">Electronics</span>
                </div>
                <a href="https://github.com/kashvi147/begginer-arduino-push-button-led" target="_blank" rel="noopener noreferrer" className="mt-5 text-sm font-semibold text-violet-400 hover:text-violet-300">View on GitHub →</a>
              </div>
            </article>
            ...
            <article className="flex flex-col overflow-hidden rounded-2xl border border-[#2a2a3a] bg-[#12121a] card-hover" data-aos="fade-up" data-aos-duration="650" data-aos-delay="100">
              ...
              <div className="flex flex-1 flex-col p-6">
                ...
                <a href="https://github.com/kashvi147/push-button-toggle-led-" target="_blank" rel="noopener noreferrer" className="mt-5 text-sm font-semibold text-violet-400 hover:text-violet-300">View on GitHub →</a>
              </div>
            </article>
            ...
            <article className="flex flex-col overflow-hidden rounded-2xl border border-[#2a2a3a] bg-[#12121a] card-hover" data-aos="fade-up" data-aos-duration="650" data-aos-delay="100">
              ...
              <div className="flex flex-1 flex-col p-6">
                ...
                <a href="https://github.com/kashvi147/toggle-led-using-2-push-buttons-1-for-off-1-for-on" target="_blank" rel="noopener noreferrer" className="mt-5 text-sm font-semibold text-violet-400 hover:text-violet-300">View on GitHub →</a>
              </div>
            </article>
            ...
            <article className="flex flex-col overflow-hidden rounded-2xl border border-[#2a2a3a] bg-[#12121a] card-hover" data-aos="fade-up" data-aos-duration="650" data-aos-delay="100">
              ...
              <div className="flex flex-1 flex-col p-6">
                ...
                <a href="https://github.com/kashvi147/smooth-led-fade-effect-using-analogWrite" target="_blank" rel="noopener noreferrer" className="mt-5 text-sm font-semibold text-violet-400 hover:text-violet-300">View on GitHub →</a>
              </div>
            </article>
            ...
            <article className="flex flex-col overflow-hidden rounded-2xl border border-[#2a2a3a] bg-[#12121a] card-hover" data-aos="fade-up" data-aos-duration="650" data-aos-delay="100">
              ...
              <div className="flex flex-1 flex-col p-6">
                ...
                <a href="https://github.com/kashvi147/Knob-controlled-brightness-of-LED-using-potentiometer" target="_blank" rel="noopener noreferrer" className="mt-5 text-sm font-semibold text-violet-400 hover:text-violet-300">View on GitHub →</a>
              </div>
            </article>
            ...
            <article className="flex flex-col overflow-hidden rounded-2xl border border-[#2a2a3a] bg-[#12121a] card-hover" data-aos="fade-up" data-aos-duration="650" data-aos-delay="100">
              ...
              <div className="flex flex-1 flex-col p-6">
                ...
                <a href="https://github.com/kashvi147/glow-red-LED-when-bright-and-Green-when-Dark" target="_blank" rel="noopener noreferrer" className="mt-5 text-sm font-semibold text-violet-400 hover:text-violet-300">View on GitHub →</a>
              </div>
            </article>
            ...
            <article className="flex flex-col overflow-hidden rounded-2xl border border-[#2a2a3a] bg-[#12121a] card-hover" data-aos="fade-up" data-aos-duration="650" data-aos-delay="100">
              ...
              <div className="flex flex-1 flex-col p-6">
                ...
                <a href="https://github.com/kashvi147/Automatic-Night-Lamp" target="_blank" rel="noopener noreferrer" className="mt-5 text-sm font-semibold text-violet-400 hover:text-violet-300">View on GitHub →</a>
              </div>
            </article>
