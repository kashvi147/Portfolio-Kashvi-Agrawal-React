function Skills() {
  return (
    <>
      <section id="skills" className="bg-[#12121a] safe-x py-16 sm:px-8 sm:py-28">
        <div className="mx-auto max-w-6xl">
          <div className="mb-10 text-center sm:mb-14" data-aos="fade-up" data-aos-duration="650">
            <span className="text-xs font-semibold uppercase tracking-widest text-violet-400 sm:text-sm">Skills</span>
